...
**Shot priority for launch:** 1. Geely Geometry E exterior · 2. Geely Geometry E interior ·
3. Chauffeur/vehicle interaction · 4. Passenger experience · 5. Other Zenvoy vehicles.

**Alt text:** every placeholder currently ships with `alt=""` so the page does not describe a
photograph that isn't there. When you drop in the real photo, write an `alt` description of what
that photo actually shows and delete the `<!-- PLACEHOLDER IMAGE -->` comment above it.

| File | Where it appears | Ratio / size | What the photograph should show |
| --- | --- | --- | --- |
| `hero-chauffeur-lagos.jpg` | Homepage hero (the first thing anyone sees) | 4:5 · 1000×1250 | **Priority 3.** The strongest image you own. A chauffeur at the rear door of a clean vehicle, or a vehicle waiting outside a recognisable Lagos building. Shoot vertical; it is cropped to 4:3 on phones. |
| `rear-seat-interior.jpg` | Homepage, "You book Zenvoy, not a driver" | 3:4 · 900×1200 | **Priority 2/4.** Rear cabin of the Geometry E, clean and prepared: the passenger's view. |
| `electric-vehicle.jpg` | Homepage electric section | 3:4 · 1000×1250 | **Priority 1.** The Geely Geometry E, three-quarter view, daylight. |
| `electric-vehicle-wide.jpg` | Electric page banner | 16:9 · 1600×900 | **Priority 1/2.** The Geely Geometry E in context, or its interior. A hotel forecourt or clean street beats a car park. |
...
| `chauffeur-standing.jpg` | How it works page | 3:4 · 900×1200 | **Priority 3.** A chauffeur, presentable, beside the vehicle. Faces are fine with consent. |
...
* No generic stock luxury cars. An honest photo of the actual Zenvoy car outperforms a borrowed Mercedes every time.
